...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing: border-box; }
        ...
        h1 { color: #1e3a8a; font-size: 1.8rem; margin-bottom: 5px; }
        ...
        .request-card p { margin: 7px 0; color: #1f2937; }
        .request-card i { width: 28px; color: #3b82f6; }
    ...
    <?php else: ?>
        <?php while ($r = mysqli_fetch_assoc($pending)): ?>
            <div class="request-card">
                ...
                <p><i class="fas fa-calendar-alt"></i> Requested: <?php echo $r['created_at']; ?></p>
